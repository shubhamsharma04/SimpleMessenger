...
public class SimpleMessengerActivity extends Activity {
    ...
    static final String ACK_MSG = "Housten_I_Got_You";
    /**
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("SimpleMessenger Page") // TODO: Define a title for the content shown.
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            while(true) {
                try {
                    Log.i(TAG, "About to read stuff1");
                    Socket client = serverSocket.accept();
                    Log.i(TAG, "About to read stuff2");
                    // Credit : https://docs.oracle.com/javase/tutorial/networking/sockets/examples/EchoServer.java
                    InputStream inputStream = client.getInputStream();
                    Log.i(TAG,"Reached1");
                    BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));
                    StringBuilder str = new StringBuilder();
                    String input;
                    Log.i(TAG, "About to read stuff10");

                    while ((input = bufferedReader.readLine())!=null) {
                        //input = bufferedReader.readLine();
                        Log.i(TAG,"Reached2 : "+input);
                        str.append(input);
                    }
                    ...
                    Log.i(TAG, "About to close streams ");
                    out.write(ACK_MSG+"\r\n");
                    try {
                        Thread.sleep(10);
                    ...
                    Log.i(TAG, "Sending stuff : " + str.toString());
...
// Credit : https://docs.oracle.com/javase/tutorial/networking/sockets/examples/EchoServer.java
                ...
                Log.i(TAG, "Inside Send : "+msgToSend);
                ...
                outputStream.close();
                out.close();
                Log.i(TAG, "Reading from server stream ");
                InputStream inputStream = socket.getInputStream();
                BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));
                StringBuilder str = new StringBuilder();
                String input;
                Log.i(TAG, "About to read from write");

                    while ((input = bufferedReader.readLine())!=null) {
                        Log.i(TAG, "Reached 3 : " + input);
                        str.append(input);
                    }

                    if (ACK_MSG.equals(str.toString())) {
                        Log.i(TAG, "Equal");

                    } else {
                        Log.e(TAG, "UnEqual : " + str.toString());
                    }
